  ...
  return (
    <header className="w-full border-b border-black/10">
      <div className="container-wide flex items-center justify-between py-5">
        ...
        <a href="https://joonasluotonen.com" target="_blank" rel="noopener noreferrer" aria-label="joonasluotonen.com" className="block shrink-0">
          <Image src="/JL-monogrammiEXTENDED.png" alt="JL logo" width={80} height={40} priority />
        </a>
      </div>
    </header>
  );
